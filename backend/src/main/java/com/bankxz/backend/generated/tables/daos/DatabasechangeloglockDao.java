...
public class DatabasechangeloglockDao extends DAOImpl<DatabasechangeloglockRecord, com.bankxz.backend.generated.tables.pojos.Databasechangeloglock, Integer> {
    ...
    public DatabasechangeloglockDao() {
        super(Databasechangeloglock.DATABASECHANGELOGLOCK, com.bankxz.backend.generated.tables.pojos.Databasechangeloglock.class);
    }
    ...
    public DatabasechangeloglockDao(Configuration configuration) {
        super(Databasechangeloglock.DATABASECHANGELOGLOCK, com.bankxz.backend.generated.tables.pojos.Databasechangeloglock.class, configuration);
    }

    @Override
    public Integer getId(com.bankxz.backend.generated.tables.pojos.Databasechangeloglock object) {
        return object.getId();
    }
     ...
     * upperInclusive</code>
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchById(Integer... values) {
     ...
     */
    public com.bankxz.backend.generated.tables.pojos.Databasechangeloglock fetchOneById(Integer value) {
     ...
     * Fetch a unique record that has <code>id = value</code>
     */
    public Optional<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchOptionalById(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchRangeOfLocked(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchByLocked(Boolean... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchRangeOfLockgranted(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchByLockgranted(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchRangeOfLockedby(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bankxz.backend.generated.tables.pojos.Databasechangeloglock> fetchByLockedby(String... values) {
